...
public abstract class GHObject {
	 ...
	 * depending on how this object was retrieved. This method was added as a kind of hack to allow the caller to
	 * retrieve OAuth scopes and such. Use with caution. The method might be removed in the future.
	 */
	@CheckForNull
	@Deprecated
